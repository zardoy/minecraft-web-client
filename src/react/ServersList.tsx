...
const ServersListBase = ({ joinServer, onProfileClick, setQuickConnectIp, ...props }: Props) => {
        ...
        >
          ...
          >
            ...
            <label style={{ fontSize: 10, display: 'flex', alignItems: 'center', gap: 5, height: '100%', marginTop: '-1px' }}>
              <input type="checkbox" checked={save} style={{ borderRadius: 0 }} onChange={({ target: { checked } }) => setSave(checked)} /> Save
            </label>
      ...
      searchRowChildrenOverride={
        ...
        >
          <div style={{ display: 'flex', gap: 3, alignItems: 'center' }}>
            ...
            <Select
              initialOptions={proxiesData.proxies.map(p => {
