...
const RendererDebugMenu = ({ worldRenderer }: { worldRenderer: WorldRendererCommon }) => {
  ...
  const {
    ...
    stopRendering,
    disableEntities
  } = useSnapshot(reactiveDebugParams)
    ...
    <div className={styles.container}>
      <div className={styles.column}>
        ...
        <Button
          ...
          onClick={() => {
            reactiveDebugParams.stopRendering = !reactiveDebugParams.stopRendering
          }}
        ...
        <Button
          ...
          onClick={() => {
            reactiveDebugParams.disableEntities = !reactiveDebugParams.disableEntities
          }}
        ...
        <div className={styles.sliderGroup}>
          <Button
            ...
            onClick={() => {
              ...
              if (newState) {
                reactiveDebugParams.chunksRenderAboveOverride = 0
              } else {
                reactiveDebugParams.chunksRenderAboveOverride = undefined
              }
            }}
          />
          <Slider
        ...
        <div className={styles.sliderGroup}>
          <Button
            ...
            onClick={() => {
              ...
              if (newState) {
                reactiveDebugParams.chunksRenderBelowOverride = 0
              } else {
                reactiveDebugParams.chunksRenderBelowOverride = undefined
              }
            }}
          />
          <Slider
