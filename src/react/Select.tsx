...
const SelectBase = ({ initialOptions, updateOptions, getCssOnInput, onValueChange, defaultValue, containerStyle, placeholder, disabled }: Props) => {
    ...
    <Creatable
      ...
      styles={{
        menuPortal(base, state) {
          return { ...base, zIndex: 10, transform: 'scale(var(--guiScale))', transformOrigin: 'top left' }
        },
        container(base, state) {
          return { ...base, position: 'relative', zIndex: 10 }
        },
        control(base, state) {
        ...
        placeholder(base, state) {
          return { ...base, padding: '3px', position: 'absolute' }
        },
        singleValue(base, state) {
          return { ...base, margin: '0px', position: 'absolute', color: 'white' }
        },
        valueContainer(base, state) {
          return { ...base, padding: '3px' }
        },
